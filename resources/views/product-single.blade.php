            ...
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ asset('assets/images/menu-2.jpg') }}" class="image-popup">
                        <img src="{{ asset($product->cover) }}" class="img-fluid" alt="Colorlib Template">
                    </a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <div class="row mt-4">
                        <form action="/cart/add-product" method="POST">
                            @csrf
                            <input type="number" name="product_id" value="{{ $product->id }}" hidden="hidden">
                            <div class="col-md-6">
                            ...
                            <button class="btn btn-lg btn-primary btn-block mt-2" type="submit">Add to cart</button>
                        </form>
                    </div>
                </div>
            </div>
